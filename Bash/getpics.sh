...
test -f pics.tgz && echo "the file exists." ||wget https://zonzorp.net/pics.tgz
rm pics.tgz
...
wget -q --spider http://zonzorp.net/pics.zip && echo "Extraction sucessfull" rm ~/public_html/pics/pics.zip ;echo "File deleted" || echo "download failed"
